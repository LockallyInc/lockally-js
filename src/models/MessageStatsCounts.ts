 ...
 * 
 * @export
 * @interface MessageStatsCounts
 */
export interface MessageStatsCounts {
    /**
     * 
     * @type {number}
     * @memberof MessageStatsCounts
     */
    delivered?: number;
    /**
     * 
...
/**
 * Check if a given object implements the MessageStatsCounts interface.
 */
export function instanceOfMessageStatsCounts(value: object): value is MessageStatsCounts {
    return true;
}

export function MessageStatsCountsFromJSON(json: any): MessageStatsCounts {
    return MessageStatsCountsFromJSONTyped(json, false);
}

export function MessageStatsCountsFromJSONTyped(json: any, ignoreDiscriminator: boolean): MessageStatsCounts {
    if (json == null) {
        return json;
    }
    return {
...
export function MessageStatsCountsToJSON(json: any): MessageStatsCounts {
    return MessageStatsCountsToJSONTyped(json, false);
}

export function MessageStatsCountsToJSONTyped(value?: MessageStatsCounts | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
