...
/**
 * Check if a given object implements the V1ApiKeysGet200Response interface.
 */
export function instanceOfV1ApiKeysGet200Response(value: object): value is V1ApiKeysGet200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function V1ApiKeysGet200ResponseFromJSON(json: any): V1ApiKeysGet200Response {
    return V1ApiKeysGet200ResponseFromJSONTyped(json, false);
}

export function V1ApiKeysGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1ApiKeysGet200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function V1ApiKeysGet200ResponseToJSON(json: any): V1ApiKeysGet200Response {
    return V1ApiKeysGet200ResponseToJSONTyped(json, false);
}

export function V1ApiKeysGet200ResponseToJSONTyped(value?: V1ApiKeysGet200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
